#ifndef MAGICIAN_MOTION_PLANNER_ROBOT_SYSTEM_INTERFACE_HPP
#define MAGICIAN_MOTION_PLANNER_ROBOT_SYSTEM_INTERFACE_HPP
...
#endif  // MAGICIAN_MOTION_PLANNER_ROBOT_SYSTEM_INTERFACE_HPP
